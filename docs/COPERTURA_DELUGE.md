...
| midi-cc | midi-cv | Automazione MIDI CC, bend e pressure | completa | completa | completa | assente | `tools/delugexml/midicv.py`, `tools/delugexml/automation.py`, `tests/test_all.py`, `docs/superpowers/specs/2026-09-25-midi-cc-bend-pressure-design.md`; CC a gradini, bend/pressure interpolabili | P1 | Aprire e ascoltare MIDIAUTO02 sulla beta 20260925; MIDIAUTO01 e' un upload parziale da eliminare, e l'upload da solo non promuove Device |
