...
COPPIE_OSSERVATE: dict[tuple[str, str], int] = {
    ...
    ('envelope1', 'carrier1Feedback'): 40,
    ('envelope2', 'carrier2Feedback'): 40,
    ('envelope2', 'modulator2Volume'): 31, ('lfo1', 'delayRate'): 30,
    ('envelope2', 'modulator1Volume'): 28, ('lfo2', 'oscAPhaseWidth'): 26,
    ('note', 'modulator1Volume'): 26, ('random', 'oscAPhaseWidth'): 22,
    ('random', 'oscBVolume'): 22, ('lfo2', 'lpfFrequency'): 19,
    ('lfo1', 'hpfFrequency'): 18, ('envelope2', 'hpfFrequency'): 16,
    ('lfo2', 'oscBVolume'): 15, ('random', 'lpfResonance'): 14,
    ('lfo1', 'lfo2Rate'): 13, ('note', 'modulator2Volume'): 13,
    ('random', 'lpfFrequency'): 13, ('envelope2', 'oscBPitch'): 12,
    ('lfo1', 'lpfFrequency'): 12, ('lfo2', 'oscAWavetablePosition'): 12,
    ...
    ('envelope2', 'oscBVolume'): 6, ('lfo1', 'oscAPhaseWidth'): 6,
    ('random', 'env2Decay'): 6, ('velocity', 'pitch'): 6,
    ('envelope2', 'env1Decay'): 5, ('envelope2', 'lpfResonance'): 5,
    ('envelope2', 'oscAPhaseWidth'): 5, ('lfo1', 'lpfResonance'): 5,
    ('lfo2', 'oscAVolume'): 5, ('lfo2', 'oscBPitch'): 5,
    ('note', 'lfo2Rate'): 5, ('random', 'oscAPitch'): 5,
    ('random', 'oscBPitch'): 5, ('aftertouch', 'lpfFrequency'): 4,
    ('envelope1', 'modulator2Volume'): 4, ('envelope1', 'oscAVolume'): 4,
    ('envelope1', 'oscBVolume'): 4, ('envelope2', 'modulator1Feedback'): 4,
    ('envelope2', 'modulator1Pitch'): 4, ('envelope2', 'oscAPitch'): 4,
    ('envelope2', 'range'): 4, ('envelope2', 'waveFold'): 4,
    ('lfo1', 'oscAVolume'): 4, ('lfo2', 'lpfResonance'): 4,
    ('note', 'hpfFrequency'): 4, ('note', 'oscBVolume'): 4,
    ('compressor', 'lpfFrequency'): 3, ('envelope1', 'env1Decay'): 3,
    ('envelope1', 'modulator1Volume'): 3, ('envelope2', 'env2Attack'): 3,
    ('envelope2', 'modulator2Feedback'): 3, ('random', 'carrier2Feedback'): 3,
    ('random', 'lpfMorph'): 3, ('velocity', 'modulator1Volume'): 3,
    ('envelope1', 'env1Attack'): 2, ('envelope1', 'lpfResonance'): 2,
    ('envelope1', 'oscBPhaseWidth'): 2, ('envelope1', 'oscBPitch'): 2,
    ('lfo1', 'env1Sustain'): 2, ('lfo1', 'modulator2Volume'): 2,
    ('lfo1', 'noiseVolume'): 2, ('lfo1', 'pan'): 2, ('lfo1', 'volume'): 2,
    ('lfo2', 'pitch'): 2, ('lfo2', 'waveFold'): 2, ('note', 'lpfResonance'): 2,
    ('random', 'lfo2Rate'): 2, ('compressor', 'lpfResonance'): 1,
    ('compressor', 'oscAPitch'): 1, ('compressor', 'oscBPitch'): 1,
    ('envelope1', 'hpfFrequency'): 1, ('envelope1', 'hpfResonance'): 1,
    ('envelope1', 'modulator1Feedback'): 1, ('envelope1', 'oscAPhaseWidth'): 1,
    ('envelope1', 'oscAPitch'): 1, ('envelope1', 'range'): 1,
    ('envelope2', 'lfo2Rate'): 1, ('envelope2', 'oscBPhaseWidth'): 1,
    ('envelope2', 'pitch'): 1, ('lfo1', 'carrier2Feedback'): 1,
    ('lfo1', 'env2Attack'): 1, ('lfo1', 'modFXDepth'): 1,
    ('lfo1', 'modFXRate'): 1, ('lfo1', 'oscAPitch'): 1,
    ('lfo1', 'oscBPhaseWidth'): 1, ('lfo1', 'oscBVolume'): 1,
    ('lfo2', 'carrier1Feedback'): 1, ('lfo2', 'carrier2Feedback'): 1,
    ('lfo2', 'hpfResonance'): 1, ('lfo2', 'modulator1Pitch'): 1,
    ('lfo2', 'modulator2Volume'): 1, ('lfo2', 'noiseVolume'): 1,
    ('lfo2', 'oscAPitch'): 1, ('lfo2', 'pan'): 1, ('lfo3', 'hpfResonance'): 1,
    ('lfo3', 'lpfFrequency'): 1, ('lfo4', 'lfo2Rate'): 1,
    ('note', 'modulator1Feedback'): 1, ('note', 'modulator1Pitch'): 1,
    ('note', 'modulator2Feedback'): 1, ('note', 'noiseVolume'): 1,
    ('note', 'oscBPitch'): 1, ('random', 'env1Decay'): 1,
    ('random', 'env2Sustain'): 1, ('random', 'modulator1Feedback'): 1,
    ('random', 'noiseVolume'): 1, ('random', 'oscBPhaseWidth'): 1,
    ('velocity', 'env1Release'): 1, ('velocity', 'lfo2Rate'): 1,
    ('velocity', 'lpfResonance'): 1, ('velocity', 'modulator1Feedback'): 1,
    ('velocity', 'modulator1Pitch'): 1, ('velocity', 'modulator2Volume'): 1,
    ('velocity', 'oscBPitch'): 1, ('x', 'lpfFrequency'): 1,
    ('y', 'env1Attack'): 1, ('y', 'hpfFrequency'): 1, ('y', 'waveFold'): 1,
}
